...
A comprehensive, single-file interactive music theory web application built with vanilla HTML, CSS, and JavaScript. No build tools, no dependencies, no server required — open it in a browser and start learning.
